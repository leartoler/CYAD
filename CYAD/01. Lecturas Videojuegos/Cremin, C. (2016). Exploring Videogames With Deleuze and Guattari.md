...
(Concepto::Ludodiagrama (25))
	Es el canvas de el [[Videojuego]] preparado por el desarrollador hecho de signos e imágenes en las que el jugador puede componer. Es un lienzo para las fuerzas del [[jugador]]

(Concepto::Inmersión (28))
	Aparece cuando no hay un [[lag]] entre el pensamiento De una acción del jugador y esa acción.
...
(Tema::Fetichización a ciertos elementos del juego (8))
...
(Tema::Lo que es un artista (15))

(Tema::Lo que son los videojuegos(14))

(Tema::Multiplicidad (15))
...
(Tema::Percepción y magnitud (18))

(Tema::Cuerpo sin órganos (19))

(Tema::Videojuego y ser (20))

(Tema::Videojuego e indeterminación (21))

(Tema::Videojuegos (22))

(Tema::Lo que es un videojuego. Axioma 1 (23))

(Tema::Lo que es un videojuego. Axioma 2 (23))

(Tema::Lo que es un videojuegos. Axioma 3 (24)))

(Tema::Lo que es un videojuego. Axioma 4 (25))

(Tema::Lo que es un videojuegos. Axioma 5 (25))

(Tema::Lo que es un videojuego. Axioma 6 (26))

(Tema::Lo que es un videojuego. Axioma 7 (26))

(Tema::Lo que es un videojuegos. Axioma 8 (26))

(Tema::Lo que es un videojuegos. Axioma 9 (28))

(Tema::Lo que es un videojuegos. Axioma 10 (28))

(Tema::5 tipos de realismos (28))

(Tema::Lo que es un videojuegos. Axioma 11 (29))

(Tema::Lo que es un videojuegos. Axioma 12 (29))

![[Pasted image 20260316163642.png]]

![[Pasted image 20260316163701.png]]

![[Pasted image 20260316163723.png]]

![[Pasted image 20260316163738.png]]

![[Pasted image 20260316163757.png]]

![[Pasted image 20260316163830.png]]

![[Pasted image 20260316163848.png]]
...
(Nota :: Cuando habla sobre las potencialidades, el ensamblaje y estructuras abiertas se puede considerar también el pensamiento de jane bennet)[[Jane Bennett]]

(Nota::Hay una incompletitud en el juego que solo se termina cuando el juego es jugado)
...
(Idea::Los artistas son tanto creadores de afectos como hacedores (Cap. 1))

(Idea::En el caso de los videojuegos, el jugador se hace a si mismo un cuerpo sin órganos, descubriendo formas de exceder el organismo. El jugador aprende de las multiplicidades y alcanza nuevas cotas y diagrama la posibilidad de lo que podrá ser (Cap. 1))

(Idea::No interactuamos con los videojuegos como tal, somos parte del ensamble del videojuego (Cap. 1))

(Idea::Videojuegos son constelaciones o ensamblajes de afectos, fuerzas que producen sensaciones. Una constelación de activos y dinámicos conceptos (Cap. 1))

(Idea::La mecánica entendida como diagrama, ¿es posible? (Ver en axioma 7, pp. 26))
