...
(Concepto::Poética polimórfica (8))
	Término propuesto por [[D. Fox Harrell]], quien ofrece un marco para pensar cómo la [[semiótica]] y la metáfora operan con un medio computacional. 
...
(Tema::Autores de poesía y juegos)
	...
	[[Lindsay Grace]] y su discusión sobre los juegos independientes y la poesía. 
	[[Alex Mitchell]] y el concepto de desfamiliarización en cómo hacer un efecto poético en los videojuegos. 

(Tema::Separación de poesía y juegos (10))
	[[Jos Stone]] diferencía 4 tipos de juegos/poemas: 
	1. [[Poetry games]]
	2. [[Ludo poetic intertextual mutations]]
	3. [[Ludokinetic poetry]]
	4. [[Poetic games]]
...
(Tema::Poesía lírica (26))
	...
	(41) La poesía lírica es algo que podemos adecuar a nosotros, como si fuera hecho para nosotros.
...
(Nota::Huizinga había ya notado la similitud que existía entre el juego y la poesía (6). Sin embargo esto deja a un lado que Huizinga deja a un lado el videojuego y se enfoque en el juego como tal, por lo que siguiendo esta lógica todo juego debería ser poema (no es así) y no considera tampoco al juego como medio de expresión (7))

(Nota::Piotr Kubinski comenta que las herramientas para hacer poesía pueden funcionar para analizar juegos (8))

(Nota::Apreciar al juego como algo poético: uso de un simbolismo y metáforas a través de un espacio ritual, en hipérbole y con otra variedad de características líricas.)

(Nota::Cómo los videojuegos van más allá de mostrar una realidad externa orientada a objetos a una realidad interna de experiencia y realidad subjetiva (36))
...
(Idea::La interacción en los videojuegos)
	En el juego [[The Graveyard en Steam]] se observa cómo alguien de la tercera edad va de un punto A a un punto B, con objetos alrededor y con los que no se puede interactuar de forma directa. Sin embargo la interacción que se logra es metafórica y simbólica, existiendo para decir algo al jugador y no solo para llenar un espacio (a diferencia de otros juegos). Se observa entonces una relación entre lo interactivo y lo objetivo vs subjetivo en los videojuegos. 
