...
(Tema::Realidad técnica y cultura (10))
###### Imágen
...
(Tema::Lo que define al objeto técnico. Concretización (15-16))

(Tema::Funcionamiento y función (16))
###### Imágen
...
(Tema::Carácter objetual y carácter objetivo (20-21))

(Tema::Psicosociología (21))
###### Imágen
...
(Tema::Razones para estudiar lo psicosociológico (28))
...
(Tema::Objeto técnico libre (36))

(Tema::Problemas del objeto técnico liberado (36))

(Tema::Problemas de objeto de uso (36-37))

(Tema::Problema de realidad histórica (37))

(Tema::Estudio de la realidad histórica (37))

(Tema::Utilidad y simbolismo (39))

(Tema::Fenómeno de captura (39-40))
###### Imágen
...
(Tema::Esquema y límite de invención (41))
###### Imágen

![[Pasted image 20260619170337.png]]
...
![[Pasted image 20260619170827.png]]
...
![[Pasted image 20260619171024.png]]
...
(Tema::Objeto técnico y velo (45-46))
###### Imágen

![[Pasted image 20260619172732.png]]
...
![[Pasted image 20260619173516.png]]
...
(Tema::Tecnofanía (49-50))
###### Imágen

![[Pasted image 20260619174341.png]]

![[Pasted image 20260619174409.png]]
...
(Tema::Conocimiento del objeto técnico en la infancia (50))

(Tema::Edades de pregnación y tecnología (52))
###### Imágen

![[Pasted image 20260619174800.png]]
...
![[Pasted image 20260619181625.png]]
...
(Tema::Unión de cultura y civilización (58))

(Tema::Inserción del objeto técnico llevado al ostracismo (59)) 
	Acá se puede hablar de las consolas posterior al crash. 
###### Imágen

![[Pasted image 20260619182055.png]]

![[Pasted image 20260619182118.png]]


#### Segunda Parte: Historicidad del objeto técnico

##### 1. Historicidad y sobrehistoricidad
...
#####  2. Objeto de cultura y objeto técnico: alienación del objeto y virtualización del trabajo

(Tema::Condición de historicidad (61))

(Tema::Tercera alienación, la del objeto técnico (62))

(Tema::Objeto técnico alienado (62-63))
...
![[Pasted image 20260622213952.png]]

![[Pasted image 20260622214014.png]]

![[Pasted image 20260622214025.png]]


##### 3. Los grados de sobrehistoricidad
...
##### 4. Objeto técnico abierto y objeto técnico cerrado
...
![[Pasted image 20260622214848.png]]


##### 5. Apertura del objeto artesanal

(Tema::Producción artesanal (69))

(Tema::Objeto artesanal (69))
###### Imágen

![[Pasted image 20260623041045.png]]


##### 6. Cerrazón del objeto industrial; código humano y código mecánico

(Tema::Objeto industrial cerrado (70))

(Tema::Producción industrial y codificación (71))
###### Imágen

![[Pasted image 20260623041304.png]]


##### 7. La producción industrial como condición de apertura 

En la conversación, se discute la transición de objetos técnicos de ser cerrados a abiertos, destacando la importancia de las piezas que permiten esta apertura. Se menciona cómo esta evolución afecta la relación entre productores y usuarios, ya que los productores ahora están más involucrados en la creación de un ecosistema para facilitar el acceso a piezas necesarias. También se señala que, en comparación con los artesanos que producen objetos completos, el enfoque actual se centra en las piezas individuales que constituyen el objeto técnico. Además, se sugiere que en el ámbito del software, puede haber una mayor aceptación y uso de estas piezas digitales, especialmente en América Latina y las repúblicas soviéticas.

(Tema::Sobre la pieza en la producción industrial (72-75))

(Tema::Evolución de las piezas (73))

(Tema::Piezas o el elemento técnico (74))

(Tema::Apertura del objeto técnico cerrado. Red de distribución (75))

###### Imágen

![[Pasted image 20260623041609.png]]

![[Pasted image 20260623041624.png]]


##### 8. Escala microtécnica y orden macrotécnico

La discusión se centra en la relación entre la escala microtécnica y el orden macrotécnico en los objetos técnicos. La escala microtécnica se refiere a los componentes individuales del objeto, mientras que el orden macrotécnico abarca las redes de distribución e interacción que rodean a estos componentes. Se señala que el orden macrotécnico solo puede existir si hay una escala microtécnica. Además, se compara el objeto técnico, que se desarrolla de manera orgánica y no alcanza un perfeccionamiento, con el objeto industrial, que presenta una estructura más definida y un ensamblaje. Las partes del objeto que son a escala humana tienden a reflejar cambios culturales y a cerrarse en su evolución, a diferencia de la microtécnica, que se desarrolla más independientemente de la cultura. Finalmente, se concluye que la historicidad se refiere solo a los cambios que ocurren en la escala de uso humano.

(Tema::Sobrehistoricidad y nivel corporal (75))

(Tema::micrótécnica y macrotécnica (75))

(Tema::Sobre el artesano y el objeto que realiza (76))

(Tema::Subconjunto concretizado (76))

(Tema::Historia y objeto técnico (77))

(Tema::Sobrehistoricidad del objeto técnico en el régimen industrial (78))

###### Imágen

![[Pasted image 20260623042101.png]]

![[Pasted image 20260623042116.png]]
...
(Nota::El mundo objetual del objeto técnico es un efecto directo de su realidad objetiva revela algo objetivo sobre aquello que puede ser un objeto técnico para un grupo determinado. Esto por todo lo que está individuado el objeto técnico (22))
...
(Nota::La cultura debe incorporar seres técnicos bajo la forma de conocimiento y de sentido de valores (27))

(Nota::Para mantener la oposición entre cultura y técnica sea falsa es necesario 2 tipos de conocimiento: 1 conocimiento de la cultura y 2, conocimiento de la realidad técnica según su esencia (27))

---

(Nota::Hay tecnicidad de las operaciones y tecnicidad de los objetos que resultan de dichas operaciones. Se desemboca en un objeto técnico o de arte (35))

(Nota::La obra domestica al operador por medio de un retorno de la eficiencia cuando emana de un operador o de un gesto operatorio (35))

(Nota::EL objeto técnico tiene un halo de socialidad. Está parcialmente sobredeterminado como símbolo psicosocial (37))

(Nota::Tecnicidad y sacralidad tienen en común lo plurivocidad y pluricundionalidad de las imágenes y estructuras (40))

(Nota::Un objeto técnico abstracto, un concepto materializado, no es un verdadero objeto técnico, sino un montaje pedagógico o científico (40))
[[objeto técnico abstracto]]


(Nota::La aceptación o el rechazo de tal tipo de objeto técnico comprometen al hombre casi a una elección moral (40))

---

(Nota:: Leroi-Gpurham estudió sobre la técnica y los objetos (41))
	#Leroi-Gourham

(Nota::Cultura y civilización seria lo mismo pero se consideran desfasados en tanto hay una evolución técnica que premia la civilización (segunda parte))

(Nota:: La civilización avanza velomente, en cambio la cultura no, esto deja al pasado con mayor contenido y simbolos que al futuro (42))

(Nota::La estética industrial es algo en donde sus componentes están sobredeterminados en imágenes y símbolos. Se consume ahí una tecnofanía (47))
	#tecnofanía #sobredeterminación 

(Nota::Las tecnofanías reconocidas por la cultura autoriza el nacimiento de formas de arte vinculadas con la expansión de las técnicas (48))

(Nota::Hay una creencia de que lo rural trabaja sobre el desecho o una degradación de lo urbano (55))

(Nota::El acto de compra y venta no agota la realidad completa del objeto; no da todo el poder del objeto ya que algo queda (58))

---

(Nota::Mircea Eliade opone la historicidad de la civilización a la intemporalidad de la cultura. Simondon ajusta un poco eso (59))
	#Mircea_Eliade

(Nota::Cuanto más complejo es el objeto más está vinculado a aspectos sociales y se encuentra más detallado (60))

(Nota::La historicidad psicosocial interfiere con la historicidad de uso del objeto técnico. Dicha historicidad psicosocial es parcialmente independiente de la historicidad como objeto de uso(60))

(Nota::El objeto técnico es separable del grupo que lo ha producido, de las circunstancias sociales que lo hicieron posible. El objeto técnico parte de procesos de causalidad acumulativa, es trabajo concretizado y desligable del productor (61))

(Nota::Los objetos técnicos, aunque no estén vivos, mantienen la cristaliazación de algo viviente (63))

(Nota::Existen aspectos de isomorfismo entre la tecnicidad y la sacralidad (63))

(Nota::El acto de reparación recupera actitudes y procedimientos del acto de producción (69))
...
(Idea::Bajo la idea del juguete y el arquetipo, un videojuego tiene una mayor cercanía debido a que no solo es su forma, sino su esquema, su funcionamiento.)

(Idea::Cuando se habla sobre subgrupos temporarios se puede emplear el que pueda existir entre el videojuego y otros sugrupos como los gamers o, incluso, entre sus diferentes distinciones)

(Idea::Hay mucha alienación con los juegos AAA y hubo durante el crash. En cambio los indies no tienen tanto esta separación entre el productor y el juego.)

(Nota::La sobrehistoricidad produce un cambio acelerado, recorta épocas, periodos (77))

(Idea::La producción artesanal corresponde a objetos ajustables, reparables y hay una gran adaptación de cada una de las piezas. Esto puede sonar similar a los objetos abiertos, pero también al este tipo de objetos o tecnología que hubo, por ejemplo, en la antigua Checoslovaquia o en el lado comunista de la Unión Soviética y Alemania, en la que, bueno, incluso también en América Latina y México, que sea en uso de tecnologías. No de forma industrial sino artesanal y bueno que también dio pie al uso y auge de la piratería entonces hay que ver este tipo de conceptos y tratarlos de unir en realidad entonces estaría hablando de que este tipo de consolas era tanto tecnología cerrada como tecnología abierta.)

(Idea::En la página 72 se discute cómo la producción de objetos cerrados está relacionada con los caracteres de totalidad. Se menciona que hay una comunicación que busca dichos caracteres de totalidad, haciendo alusión a una mitología semivitalista. Un ejemplo dado es el de un auto calificado como "inteligente", aunque se mencionó en el contexto de 1960. Se establece un paralelismo con el actual discurso sobre la inteligencia artificial, sugiriendo que estas tecnologías poseen características basadas en una noción de totalidad, incluyendo las tecnologías de red.)
